...
| 6 | Pricing Scan | Legacy pricing grep | ✅ PASS | Zero legacy refs ($49, $149, Starter, Pro) |
...
| 13 | API Deploy | `deploy-minimal.js` to Cloudflare | ⚠️ MANUAL | Script updated to Build 116; requires `npx wrangler deploy` |
| 14 | Frontend Deploy | Pages deploy | ⚠️ MANUAL | Cloudflare Pages deployment ready |
| 15 | Smoke Tests | Live curl checks | ✅ PASS | api.buildsignal.net: 200 OK |
| 16 | Rollback | Git tags + wrangler config | ✅ PASS | build-115 and build-116 tags created |

**Pipeline Result:** 13/16 PASS, 3/16 MANUAL (Gates 13, 14 require manual wrangler execution)
