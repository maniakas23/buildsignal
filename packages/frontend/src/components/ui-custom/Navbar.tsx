...
import { Building2, Menu, Bell, User, LogOut, Search, X, ChevronDown, Map, BarChart3, Lightbulb, Shield, CreditCard, Settings, HelpCircle } from "lucide-react";
              ...
              {isUserMenuOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-card border rounded-lg shadow-lg z-50">
                  <div className="p-3 border-b">
                    ...
                    <div className="text-xs text-muted-foreground">{user.data?.email || "user@example.com"}</div>
                  </div>
                  <div className="p-2">
                    <button
