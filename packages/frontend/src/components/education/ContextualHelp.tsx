...
import { HelpCircle, X, ChevronRight, BookOpen, Video, MessageCircle } from "lucide-react";
...
export function ContextualHelp() {
  ...
  const topics = [
    ...
    { id: "alerts", title: "Understanding Alerts", icon: MessageCircle, content: "Alerts notify you of significant market changes. You can acknowledge or archive them from the Alerts page." },
    { id: "recommendations", title: "AI Recommendations", icon: Video, content: "Our AI analyzes market data to provide personalized recommendations. Higher confidence scores indicate stronger signals." },
  ];
