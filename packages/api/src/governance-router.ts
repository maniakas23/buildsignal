...
function getPolicyContent(policyId: string): string | undefined {
  const contents: Record<string, string> = {
    privacy: `BUILDSIGNAL PRIVACY POLICY
...
\n5. YOUR RIGHTS
You have the right to access, correct, delete, and export your data. Contact privacy@buildsignal.net for data requests.
\n6. DATA RETENTION
...
\n7. CONTACT
BuildSignal Privacy Team
privacy@buildsignal.net
\nData Protection Officer: dpo@buildsignal.net`,

    terms: `BUILDSIGNAL TERMS OF SERVICE
\nEffective Date: July 18, 2026
...
All content, algorithms, and data structures are the property of BuildSignal. You receive a limited license to use the service.
\n6. DATA OWNERSHIP
You retain ownership of your data. BuildSignal claims ownership of derived analytics, patterns, and aggregated insights.
\n7. LIMITATION OF LIABILITY
BuildSignal's liability is limited to the amount paid for the service in the preceding 12 months.
\n8. TERMINATION
...
legal@buildsignal.net`,
    ...
    data_processing: `BUILDSIGNAL DATA PROCESSING AGREEMENT
\nEffective Date: July 18, 2026
\nThis Data Processing Agreement ("DPA") forms part of the Terms of Service between BuildSignal ("Processor") and the Customer ("Controller").
...
\n3. SUBPROCESSORS
BuildSignal uses the following subprocessors:
...
\nContact: dpa@buildsignal.net`,

    security: `BUILDSIGNAL SECURITY POLICY
\nEffective Date: July 18, 2026
...
\n10. CONTACT
security@buildsignal.net`,

    data_governance: `BUILDSIGNAL DATA GOVERNANCE POLICY
\nEffective Date: July 18, 2026
\n1. DATA PRINCIPLES
...
• Data quality scorecards per provider`,
    ...
    data_retention: `BUILDSIGNAL DATA RETENTION POLICY
\nEffective Date: July 18, 2026
...
This policy supports compliance with GDPR, CCPA, and other applicable data protection frameworks.`,
    ...
    incident_response: `BUILDSIGNAL INCIDENT RESPONSE PLAN
\nEffective Date: July 18, 2026
\n1. PURPOSE
...
\n6. CONTACT
security@buildsignal.net (24/7 monitored)`,

    business_continuity: `BUILDSIGNAL BUSINESS CONTINUITY PLAN
\nEffective Date: July 18, 2026
\n1. OBJECTIVE
...
Quarterly BCP drills simulate provider outage and infrastructure failure scenarios.`,
    ...
    disaster_recovery: `BUILDSIGNAL DISASTER RECOVERY PLAN
\nEffective Date: July 18, 2026
\n1. SCOPE
...
\n5. COMMUNICATION
Status page: status.buildsignal.net
...
Backup restoration: Monthly`,
    ...
    vulnerability_disclosure: `BUILDSIGNAL VULNERABILITY DISCLOSURE POLICY
\nEffective Date: July 18, 2026
\n1. SCOPE
...
\n4. REPORTING
Submit findings to: security@buildsignal.net
...
With your permission, we will acknowledge your contribution on our Security Hall of Fame page.`,
    ...
    acceptable_use: `BUILDSIGNAL ACCEPTABLE USE POLICY
\nEffective Date: July 18, 2026
\n1. PURPOSE
...
\n4. REPORTING
Report violations to: abuse@buildsignal.net
\n5. MODIFICATIONS
BuildSignal reserves the right to modify this policy with 30 days notice.`,

    cookie_policy: `BUILDSIGNAL COOKIE POLICY
\nEffective Date: July 18, 2026
\n1. WHAT ARE COOKIES
...
privacy@buildsignal.net`,
    ...
    accessibility: `BUILDSIGNAL ACCESSIBILITY POLICY
\nEffective Date: July 18, 2026
\n1. COMMITMENT
BuildSignal is committed to making Kestovar accessible to all users, including those with disabilities.
\n2. STANDARDS
...
\n5. FEEDBACK
We welcome feedback on accessibility. Contact: accessibility@buildsignal.net
